...
namespace WFARTHA.Services
{
    public class ProcesaFlujo
    {
        ...
        public string procesaPreliminar(DOCUMENTO d, bool edit, string nuevo, bool borrado)//MGC 06-12-2018 Firma del usuario cancelar
        {
        ...
        public string procesa(FLUJO f, string recurrente, bool edit, string email, string nuevo_acc)
        {
            ...
            if (f.ESTATUS.Equals("I"))//--------------------------------------------------------------------------------------NUEVO REGISTRO
            {
                ...
                else
                {
                    ...
                    string corr = procesaPreliminar(d, edit, nuevo_acc, false);
