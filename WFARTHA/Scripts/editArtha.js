        ...
        if (jsval[0].ID === "SSO") {
            ...
            for (var i = 0; i < length; i++) {
                ...
                if (nr === 0) {
                    ...
                    tdata = "<tr><td></td><td style=\"text - align: left\">" + (i + 1) + "</td><td style=\"text - align: left\">OK</td><td style=\"text - align: left\">" + file.name + "</td><td style=\"text - align: left\">" + fileNameExt + "</td><td style=\"text - align: left\"><input name=\"labels_desc\" class=\"Descripcion\" style=\"font-size:12px;\" type=\"text\" id=\"\" name=\"\" value=\"\"></td><td></td></tr>";
                    //Lejgg 22-10-2018
